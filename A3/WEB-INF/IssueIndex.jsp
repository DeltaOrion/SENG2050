...
<form class="form-style-2" name="sortForm" action="${pageContext.request.contextPath}/IssueIndex">
    <fieldset>
        ...
        <label for="date-option">Report Date</label> <select id="date-option" name="date-option"><option value="ASCENDING">Oldest First</option><option value="DESCENDING">Newest First</option></select> <input type="radio" id="reportDate" name="sort-type" value="reportDate"><br/>
