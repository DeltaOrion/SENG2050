...
function handleSubmit(formCriteria) {
    ...
    */
    ...
    if(!formCriteria.hasSubmitted) {
        handleOriginalFields(formCriteria,originalErrMsg);
        ...
        setOriginalFields(originalErrMsg);
    }
...
function handleOriginalFields(formCriteria, originalErrMsg) {
...
function setOriginalFields(originalErrMsg) {
